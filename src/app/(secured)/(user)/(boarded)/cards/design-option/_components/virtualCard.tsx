    ...
    <div className="flex relative flex-col h-full  w-full text-primary px-5">
      {openComingSoon ? (
        ...
        <div>
          ...
          <div className="flex justify-center items-center w-full flex-grow pb-4">
            <div className="flex justify-center items-start w-full max-w-md">
              <div
                className="flex flex-col gap-y-2 min-h-[400px] w-full rounded-md border cursor-pointer hover:border-green-500 transition-colors duration-300 py-16 px-12"
