...
const statusConfig: Record<OrderStatus, { label: string; color: string }> = {
  ...
  "To Return/Refund": { label: "To Return/Refund", color: "bg-orange-100 text-orange-800" },
        ...
        {statuses.map((status) => {
          ...
          return (
            <button
              ...
              className={cn(
                "pb-4 px-1 border-b-2 font-medium text-sm whitespace-nowrap transition-colors",
                isActive
