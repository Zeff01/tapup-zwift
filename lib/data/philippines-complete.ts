// Complete Philippines Address Data
// Based on Philippine Standard Geographic Code (PSGC) Q4 2024
...
export interface Barangay {
  name: string;
  zipCode: string; // Specific ZIP code for this barangay
}

// Complete Philippines Address Data Structure
export const completePhilippinesData: CompletePhilippinesAddress = {
  regions: [
    {
      code: "010000000",
      ...
      provinces: [
        {
          ...
          cities: [
            ...
            },
            {
              ...
              zipCode: "2906",
              barangays: [
                { name: "Baoa East", zipCode: "2906" },
                { name: "Baoa West", zipCode: "2906" },
                { name: "Ben-agan", zipCode: "2906" },
                { name: "Bil-loca", zipCode: "2906" },
                { name: "Binacag", zipCode: "2906" },
              ]
            }
          ]
        },
        {
          ...
          cities: [
            ...
            },
            {
              ...
              zipCode: "2710",
              barangays: [
                { name: "Allangigan 1st", zipCode: "2710" },
                { name: "Allangigan 2nd", zipCode: "2710" },
                { name: "Amguid", zipCode: "2710" },
                { name: "Ayudante", zipCode: "2710" },
