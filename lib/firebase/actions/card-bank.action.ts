...
export async function generateBulkCards(
  ...
  try {
    ...
    console.log(`[generateBulkCards] Generated by:`, { userId, userEmail, userName });
    ...
    if (userId) {
      console.log(`[generateBulkCards] Creating log entry for user:`, { userId, userEmail, userName });
