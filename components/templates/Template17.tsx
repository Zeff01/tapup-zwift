        ...
        <div className="bg-white rounded-2xl sm:rounded-3xl shadow-xl w-full max-w-full sm:max-w-md mx-auto overflow-hidden font-sans text-black py-2 px-1">
            ...
            <div className="pt-12 sm:pt-16 pb-4 sm:pb-6 px-4 sm:px-6 flex flex-col items-center">
                ...
                <div className="flex gap-2 sm:gap-3 justify-center mt-3 sm:mt-4 flex-wrap">
                    {facebookUrl && (
                        <a href={facebookUrl} target="_blank" rel="noopener noreferrer" className="bg-gray-100 hover:bg-gray-200 p-2 rounded-full">
                            <FaFacebookF className="text-[#1877F3] text-sm sm:text-lg" />
                        </a>
                    )}
                    {linkedinUrl && (
                        <a href={linkedinUrl} target="_blank" rel="noopener noreferrer" className="bg-gray-100 hover:bg-gray-200 p-2 rounded-full">
                            <FaLinkedinIn className="text-[#0A66C2] text-sm sm:text-lg" />
                        </a>
                    )}
                    {instagramUrl && (
                        <a href={instagramUrl} target="_blank" rel="noopener noreferrer" className="bg-gray-100 hover:bg-gray-200 p-2 rounded-full">
                            <FaInstagram className="text-[#E4405F] text-sm sm:text-lg" />
                        </a>
                    )}
                    {websiteUrl && (
                        <a href={websiteUrl} target="_blank" rel="noopener noreferrer" className="bg-gray-100 hover:bg-gray-200 p-2 rounded-full">
                            <FaGlobe className="text-gray-700 text-sm sm:text-lg" />
                        </a>
                    )}
                    {twitterUrl && (
                        <a href={twitterUrl} target="_blank" rel="noopener noreferrer" className="bg-gray-100 hover:bg-gray-200 p-2 rounded-full">
                            <FaTwitter className="text-[#1DA1F2] text-sm sm:text-lg" />
                        </a>
                    )}
                    {youtubeUrl && (
                        <a href={youtubeUrl} target="_blank" rel="noopener noreferrer" className="bg-gray-100 hover:bg-gray-200 p-2 rounded-full">
                            <FaYoutube className="text-[#FF0000] text-sm sm:text-lg" />
                        </a>
                    )}
                    {whatsappNumber && (
                        <a href={`https://wa.me/${whatsappNumber}`} target="_blank" rel="noopener noreferrer" className="bg-gray-100 hover:bg-gray-200 p-2 rounded-full">
                            <FaWhatsapp className="text-[#25D366] text-sm sm:text-lg" />
                        </a>
                    )}
                    {skypeInviteUrl && (
                        <a href={skypeInviteUrl} target="_blank" rel="noopener noreferrer" className="bg-gray-100 hover:bg-gray-200 p-2 rounded-full">
                            <FaSkype className="text-[#00AFF0] text-sm sm:text-lg" />
                        </a>
                    )}
                    {viberUrl && (
                        <a href={viberUrl} target="_blank" rel="noopener noreferrer" className="bg-gray-100 hover:bg-gray-200 p-2 rounded-full">
                            <FaViber className="text-[#665CAC] text-sm sm:text-lg" />
                        </a>
                    )}
                    {tiktokUrl && (
                        <a href={tiktokUrl} target="_blank" rel="noopener noreferrer" className="bg-gray-100 hover:bg-gray-200 p-2 rounded-full">
                ...
                <div className="flex flex-col sm:flex-row gap-2 sm:gap-3 w-full mt-4 sm:mt-6">
                    ...
                    <button className="flex-1 border border-[#FF4B5C] text-[#FF4B5C] py-2.5 sm:py-2 rounded-full font-semibold flex items-center justify-center gap-2 text-sm hover:bg-[#FFF0F1]">
            ...
            <div className="px-4 sm:px-6 pb-2">
                <h3 className="font-bold text-sm sm:text-base mb-1">Company Overview</h3>
            ...
            <div className="bg-[#FF4B5C] text-white text-center py-3 sm:py-4 rounded-b-2xl sm:rounded-b-3xl">
                ...
                <div className="text-xs mt-1">© 2024 Zwiftech. All Rights Reserved.</div>
            </div>
        </div>
    );
};
