...
const Template16 = ({
  ...
  return (
    ...
    >
              ...
              <div className="flex-1 mt-2 sm:mt-3 text-center sm:text-left">
                ...
                <div className="flex flex-wrap justify-center gap-3 mt-4">
                  <SocialLinks
                    ...
                    ownerId={owner}
                    size="sm"
                    iconClassName="rounded-full p-2 bg-[#1D1D1D] text-white hover:bg-gray-800 size-full "
                    iconSet="outline"
            ...
            >
              <div className="flex gap-3 w-full justify-center">
                <CTAButtons
                  ...
                  size="md"
                  icons="lucide"
                  buttonClassName="bg-[#1D1D1D] text-white hover:bg-gray-800"
                />
              </div>
            </section>
          </section>
      ...
      <TemplateFooter
        theme={"light"}
        className="w-full max-w-md px-6 text-center text-sm mt-2"
        yearClassName="tracking-wide text-gray-800 text-[10px]"
      />
