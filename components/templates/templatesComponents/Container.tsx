...
export const TemplateContainer: React.FC<ContainerProps> = ({
  ...
  return (
    <div 
      ...
      style={mergedStyles}
    >
      <div className={cn(innerContainerClasses, flex && "flex flex-col flex-grow min-h-full")}>
        {children}
      </div>
    </div>
  );
...
export const Template1Container: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <TemplateContainer
    backgroundColor="bg-white"
    padding="sm"
    maxWidth="480px"
...
export const Template2Container: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <TemplateContainer
...
export const Template3Container: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <TemplateContainer
...
export const Template4Container: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <TemplateContainer
    backgroundColor="bg-white"
    padding="none"
    maxWidth="480px"
...
export const Template5Container: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <TemplateContainer
    backgroundColor="bg-white"
...
export const Template6Container: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <TemplateContainer
    backgroundColor="bg-white"
    padding="none"
    maxWidth="480px"
...
export const Template7Container: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <TemplateContainer
    backgroundColor="bg-white"
    padding="md"
    maxWidth="480px"
...
export const Template8Container: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <TemplateContainer
    backgroundColor="bg-white"
    padding="md"
    maxWidth="480px"
...
export const Template9Container: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <TemplateContainer
