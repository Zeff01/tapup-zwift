...
const availableTemplates: { id: ChosenTemplateType; name: string; category: string }[] = [
              ...
              <AnimatePresence>
                {showTemplateSelector && (
                  ...
                  >
                    <Card>
                      <CardHeader className="pb-2">
                        <CardTitle className="text-sm">Quick Template Switch</CardTitle>
                      </CardHeader>
                      <CardContent>
                  ...
                  <div className="flex items-start gap-2">
                    ...
                    <div>
                      <p className="text-sm text-blue-700 dark:text-blue-300">
                        <strong>📱 Mobile-First:</strong> Your digital business card is optimized for mobile devices. 
                        All changes update instantly as you type!
                      </p>
                    </div>
                  </div>
                </CardContent>
