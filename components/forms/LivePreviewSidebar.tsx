...
const availableTemplates: {
  ...
  { id: "template7", name: "Blue Professional", category: "Professional" },
  { id: "template8", name: "Modern Wave", category: "Modern" },
  ...
  { id: "template14", name: "Coming Soon", category: "Coming Soon" },
