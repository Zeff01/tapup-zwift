...
const PhysicalCard3 = (data: Partial<Card>) => {
  return (
    <div className="relative aspect-[1.586/1] [perspective:1000px] group">
      <div className="relative w-full h-full transition-transform duration-500 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)]">
        {/* Front of card */}
        <div className="absolute inset-0 rounded-lg [backface-visibility:hidden] bg-gradient-to-br from-yellow-700 via-amber-500 to-yellow-800">
          <div className="p-6">
        ...
        {/* Back of card */}
        <div className="absolute inset-0 rounded-lg [backface-visibility:hidden] [transform:rotateY(180deg)] bg-gradient-to-br from-yellow-700 via-amber-500 to-yellow-800">
