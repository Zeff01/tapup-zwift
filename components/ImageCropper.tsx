...
export default function ImageCropper({
  ...
  // Determine the cropper title based on context
  const getCropperTitle = () => {
    if (cropperTitle) return cropperTitle;
    if (circularCrop) return "Crop Profile Photo";
    if (aspect === 16/9) return "Crop Cover Photo";
    return "Crop Image";
  };
