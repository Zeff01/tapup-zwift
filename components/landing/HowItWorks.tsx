...
const HowItWorks = () => {
  return (
    <section className="py-8 px-4 gap-2 relative overflow-hidden " id="quickguide">
      ...
      <div className="w-full pt-[-4rem]">
        <div className="flex items-center justify-center gap-3 font-inter mb-10">
          ...
          <span  className="text-3xl sm:text-4xl md:text-5xl lg:text-[4vw] leading-tight md:leading-none text-center font-bold">works</span>
        </div>
          ...
          {stepItem.map((item, index) => (
            ...
            >
              <h3 className="text-xl md:text-6xl font-bold">
                <span className="text-checkColor font-bold">
                {index + 1}
                </span>
